...
function cssInit(t, i) {
    return (t += "ms"), (i += "ms"), { "animation-duration": i, "transition-timing-function": "ease", "transition-delay": t };
}
                ...
                i(g).attr("aid", b),
                    ...
                    e.push([
                        ...
                        setTimeout(function () {
                            ...
                            i(window).width() < 768 && (isEmpty(d) || "scroll" === d || "load" === d) && (t = "fade-in"),
                                a.push([
                                    b,
                                    setTimeout(function () {
                ...
                if (e.length > 0) {
                    if (-1 === i.indexOf("collapse"))
                        try {
                            jQuery("html, body")
                                .stop()
                                .animate({ scrollTop: e.offset().top - 150 }, 900, "swing", function () {
    ...
    (function ($) {
        ...
        !(function (t) {
                ...
                function a(i, s, n) {
                    ...
                    if (arguments.length > 1) {
                        ...
                        return (
                            ...
                            (document.cookie = [i, "=", s, n.expires && "; expires=" + n.expires.toUTCString(), n.path && "; path=" + n.path, n.domain && "; domain=" + n.domain, n.secure ? "; secure" : ""].join(""))
                        );
                    }
                    i || (o = {});
                    for (var l = document.cookie ? document.cookie.split("; ") : [], c = /(%[0-9A-Z]{2})+/g, d = 0; d < l.length; d++) {
                        ...
                        try {
                            if (((f = (e && e(f, m)) || f.replace(c, decodeURIComponent)), this.json))
                                try {
                                    f = JSON.parse(f);
                                } catch (t) {}
                            if (i === m) {
            ...
            ($.fn.showAnima = function (t, i) {
                ...
                "default" === t && (t = $.fn.getGlobalVar("default_anima")),
                    ...
                    isEmpty(i) || "complete" !== i
                        ...
                        : ($(e).attr("data-anima", t).attr("data-trigger", "manual"), initAnima(e));
            }),
            ($.fn.titleFullScreen = function (t) {
                if (!isEmpty(this)) {
                    var i = $(this).find(".overlaybox");
                    $(this).sizeFullScreen(t),
                        "absolute" !== $("header").css("position") && "fixed" !== $("header").css("position") && $(this).css("height", $(this).height() - $("header").height() + "px"),
                        isEmpty(i) || $(i).css("margin-top", "-" + $(i).height() / 2 - 10 + "px");
                }
            }),
            ($.fn.sizeFullScreen = function (t) {
                isEmpty(this) ||
                    ((t = $(window).outerHeight() - parseInt($(this).css("margin-top").replace("px", ""), 10) - parseInt($(this).css("margin-bottom").replace("px", ""), 10) - (isEmpty(t) ? 0 : parseInt(t, 10))) > $(this).height() &&
            ...
            ($.fn.executeFunction = function (t, i) {
                var e;
                $(this).length > 0 &&
                    ("function" == typeof window.jQuery.fn[t] || "function" == typeof window[t]
                        ? i()
                    ...
                    $(this).hasClass("maso-box") && ((i = !0), (t = this)),
                        e.on("progress", function (e, a) {
                            ...
                            $(a.img).closest("ul.slides").length && (n = ".slides li"),
                                ...
                                $(a.img).closest(".img-box.thumbnail span img").length && (n = "span"),
                            ...
                            if ((isEmpty(o.get(0)) || ((c = o.get(0).clientWidth), (d = o.get(0).clientHeight)), "loaded" == s)) {
                                ...
                                if (r > d) $(a.img).css("margin-top", "-" + Math.floor((r - d) / 2) + "px");
                                    ...
                                    m / l > 1 &&
                                        ...
                                        $(a.img).css("margin-left", "-" + Math.floor((m - c) / 2) + "px"));
                                }
                            }
                        });
                }
            ...
            ($.fn.initMagnificPopup = function () {
                ...
                if ((isEmpty(i) || (i.split(","), (n = getOptionsString(i, n))), isEmpty(n.mainClass) && (n.mainClass = ""), "load" == e || "scroll" == e)) {
                    var o = $(t).attr("data-link"),
                        r = $(t).attr("data-click");
                    isEmpty(o) ? ((s = "#" + $(this).attr("id")), (n.mainClass += " custom-lightbox")) : (s = o),
                        isEmpty(r) ||
                            $("body").on("click", ".lightbox-on-load", function () {
                                "_blank" == $(t).attr("data-click-target") ? window.open(r) : (document.location = r);
                            });
                }
                ($(t).hasClass("grid-box") || $(t).hasClass("maso-box")) && ((n.type = "image"), (n.delegate = "a.img-box,.advs-box a:not(.img-box)"), (n.gallery = { enabled: 1 })),
                    (-1 == s.indexOf(".jpg") && -1 == s.indexOf(".png")) || (n.type = "image"),
                    0 == s.indexOf("#") && ((n.type = "inline"), (n.mainClass += " box-inline"), (n.closeBtnInside = 0)),
                    (n.callbacks = {
                        open: function () {
                            var t = $(".mfp-content");
                            if (
                                (isEmpty(a) ? isEmpty(i) || -1 == i.indexOf("anima:") || ($(t).showAnima(n.anima), $(t).css("opacity", 0)) : ($(t).showAnima(a), $(t).css("opacity", 0)),
            ...
            ($.fn.initFlexSlider = function () {
                ...
                var i,
                    ...
                    n = {
                        ...
                        start: function () {
                            !$(e).hasClass("advanced-slider") && $.fn.renderLoadedImgs && $(e).find(".slides").renderLoadedImgs(),
                                $(e).hasClass("carousel") &&
                                    $(e)
                                        .find(".slides > li")
                                        .css("width", a + "px"),
                                ($(e).hasClass("thumb") || $(e).hasClass("nav-middle")) &&
                                    $(e)
                                        ...
                                        .css("top", $(e).find(".slides > li img")[0].clientHeight / 2 + "px"),
                                $(e)
            ...
            $(document).ready(function () {
                ...
                function s() {
                    $("meta[content='wordpress']").length &&
                        ...
                        jQuery.ajax({ method: "POST", url: ajax_url, data: { action: "hc_get_wc_cart_items" } }).done(function (t) {
                            if (!isEmpty(t) && t.length > 10) {
                                var i = JSON.parse(t);
                                if (i.length > 0) {
                                    for (var e = $(".shop-menu-cnt"), a = $(e).find(".cart-total").attr("data-currency"), s = 0, n = "", o = 0; o < i.length; o++)
                                    ...
                                    $(e).find(".shop-cart").html(n),
                                        ...
                                        $(e)
                                            .find("i")
                                            .html('<span class="cart-count">' + i.length + "</span>");
                                }
                            }
                        });
                }
                ...
                if (
                    ...
                    $("body").on("click", "[data-social]", function () {
                        ...
                        "share-twitter" == t && ((a = "https://twitter.com/intent/tweet?text=" + $("meta[name=description]").attr("content")), isEmpty(i) || (a = "https://twitter.com/intent/tweet?url=" + i)),
                            "share-google" == t && (a = "https://plus.google.com/share?url=" + e),
                            "share-linkedin" == t && (a = "https://www.linkedin.com/shareArticle?url=" + e),
                            openWindow(a);
                    }),
                ...
                if (
                    ...
                    (o = $(".one-page-menu,.navbar-nav.inner,.side-menu:not(#fullpage-menu)")),
                    $(o).each(function () {
                        onePageScroll(this);
                    }),
                ...
                $(".hamburger-button").toggleClick(
                    ...
                    (o = $(".grid-list[class^='row-'], .grid-list[class*=' row-'],.maso-list[class^='row-'], .maso-list[class*=' row-']")),
                    $(o).each(function () {
                    ...
                    $("#wpadminbar").length &&
                        ($("header").hasClass("fixed-top") && $("header > .navbar").css("margin-top", "32px"), $("header").hasClass("side-menu-header") && $("header .side-menu-fixed,header .navbar-fixed-top").css("margin-top", "32px")),
                    (o = $("header a")),
                    $(o).each(function () {
                        $(this).attr("href") == window.location.href &&
                            ($(this).closest(".dropdown-menu").length ? $(this).closest(".dropdown.multi-level:not(.dropdown-submenu),.dropdown.mega-dropdown").addClass("active") : $(this).closest("li").addClass("active"));
                    }),
                    (o = $("[data-video-youtube]")),
                    $(o).each(function () {
                        var t = $(this).attr("data-video-youtube");
                        (-1 == t.indexOf("http:") && -1 == t.indexOf("www.you") && -1 == t.indexOf("youtu.be")) ||
                            (-1 != t.indexOf("?v=") && (t = t.substring(t.indexOf("v=") + 2)), -1 != t.indexOf("youtu.be") && (t = t.substring(t.lastIndexOf("/") + 1)));
                    ...
                    $("header").hasClass("fixed-top") && $(".subline-bar").css("margin-top", $("header").height() + "px"),
                ...
                $(window).scroll(function () {
                    ...
                    var i = $(window).scrollTop(),
                        ...
                        a = $(document).height();
                    $(m).length &&
                        (t > $(window).outerHeight() ? $(m).css("visibility", "hidden") : $(m).css("visibility", "visible"),
                        $(m)
                            .find(".layer-parallax")
                        ...
                        $(f).each(function (t) {
                            arrFA.length && i > arrFA[t][0]
                                ? $(this)
                                      ...
                                      .css("position", "fixed")
                                      .addClass("active")
                                : $(this).css("top", "").css("position", "").css("left", "").removeClass("active");
                        ...
                        i > 100 &&
                            ...
                            "device-xs" == n && $(".scroll-show-mobile").removeClass("hidden"),
                            i + l > a - l ? $(".footer-parallax").css("opacity", 1) : $(".footer-parallax").css("opacity", 0)),
                        i < 100 &&
                            ((e = !0),
                            $(".scroll-hide").removeClass("hidden"),
                            $(".fp-enabled").length || $(".scroll-change").removeClass("scroll-css"),
                    ...
                    $("body").on("click", ".maso-filters a", function () {
                        ...
                        e.length &&
                            ...
                            $(i).find(".maso-box .maso-item").length < 3 && $(i).find(".load-more-maso").click();
                    }),
                    $("body").on("click", ".maso-order", function () {
                        var t = $(this).closest(".maso-list").find(".maso-box");
                        "asc" == $(this).attr("data-sort")
                            ? (t.isotope({ sortAscending: !1 }), $(this).attr("data-sort", "desc"), $(this).html("<i class='fa fa-arrow-up'></i>"))
                            : (t.isotope({ sortAscending: !0 }), $(this).attr("data-sort", "asc"), $(this).html("data-sort"), $(this).html("<i class='fa fa-arrow-down'></i>"));
                    }),
                    ...
                    $("body").on("click", ".coverflow-slider .coverflow-lightbox", function () {
                        ...
                        $(t).hasClass("flip-current") && ($.magnificPopup.open({ items: { src: $(this).attr("href") }, type: $(this).hasClass("mfp-iframe") ? "iframe" : "image" }), e.preventDefault());
                    }),
                            ...
                            if (t.indexOf("list") > -1) $(i + ".grid-box .grid-item:nth-child(" + t.replace("list-", "") + ") .img-box").click(), $(i + ".maso-box .maso-item:nth-child(" + t.replace("list-", "") + ") .img-box").click();
                                ...
                                if ($(e).length)
                                    if ($(e).hasClass(".img-box") || $(e).hasClass(".lightbox")) $(e).click();
                                        ...
                                        a.length ? $(a).click() : $(e).hasClass("box-lightbox") && $.magnificPopup.open({ type: "inline", items: { src: "#" + t }, mainClass: "lightbox-on-load" });
                                    }
                            }
                    }),
                        ...
                        $("[data-parallax]").each(function () {
                            ...
                            $(".section-bg-image,.section-bg-animation,[data-parallax].header-title").each(function (t) {
                                ...
                                $(this).hasClass("ken-burn") && (i = "ken-burn"),
                                    ...
                                    $(this).hasClass("ken-burn-center") && (i = "ken-burn-center"),
                                    $(this).hasClass("parallax-side") && (i += " parallax-side-cnt"),
                                    i.length > 0 &&
                                        setTimeout(function () {

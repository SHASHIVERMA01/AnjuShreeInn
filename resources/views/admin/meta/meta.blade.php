...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
             <a href="{{route('meta.add')}}"><button type="button" class="btn btn-primary">Add</button></a> 
        </div>
    </div>
    <!--end breadcrumb-->

    <h6 class="mb-0 text-uppercase">Meta</h6>
    <hr />
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$data->id}}</td>
                            <td>{{$data->meta_heading}}</td>
                            <td>{{$data->meta_content}}</td>
                           
                            <td>
                                <form action="{{route('meta.edit',$data->id)}}" method="get">
                                    {{csrf_field()}}

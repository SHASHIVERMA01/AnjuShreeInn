...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{route('menu.add')}}"><button type="button" class="btn btn-primary">Add</button></a>
        </div>
    </div>
    <!--end breadcrumb-->

    <h6 class="mb-0 text-uppercase">Menu Page</h6>
    <hr />
    <div class="card">
        <div class="card-body">
                ...
                <table id="table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$data->menu}}</td>
                            <td>
                                <form action="{{route('menu.edit',$data->id)}}" method="get">
                                    {{csrf_field()}}

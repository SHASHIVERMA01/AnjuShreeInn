...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <h6 class="mb-0 text-uppercase">Banner ADD</h6>
            <hr>
            <!-- <div class="card"> -->
            <!-- <div class="card-body"> -->
            <div class="p-4 border rounded" style="background: #fff">
                <form class="row g-3" method="post" action="{{route('banner.store' ,$banner->mobile_banner ?? '')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input class=" form-control" id="cimage" name="id" value="{{$banner->id ?? ''}}" type="text" hidden>	
                    <div class="col-md-8">
                        <h4>Banner</h4>
                        ...
                        <img src="/storage/homepage/{{$banner->image}}" alt="" class="img-thumbnail">
                        @endif
                    </div>
...
<!-- Mobile Banner -->
                    ...
                    <h4>Mobile Banner</h4>
                        <label for="validationDefault02" class="form-label"> </label>
                        <input class=" form-control" id="cimage" name="mobile_banner" type="file" value=""
                            {{(request()->segment(5)) ? '' : 'required'}}>
                        <p style="color:red">{{$errors->first('image')}}</p>
                        @if(!empty($banner->mobile_banner))
                        <img src="/storage/homepage/{{$banner->mobile_banner}}" alt="" class="img-thumbnail">
                        @endif
                    </div>
<!-- Mobile Banner -->

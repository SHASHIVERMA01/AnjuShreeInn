...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{route('blog.add')}}"><button type="button" class="btn btn-primary">Add</button></a>
        </div>
    </div>
    <!--end breadcrumb-->
                ...
                <table id="table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <img src="/storage/homepage/{{$data->image_two}}" alt="" class="img-thumbnail" width="230" height="70"></td>
                            <td>
                                <form action="{{route('blog.edit',$data->id)}}" method="get">
                                    {{csrf_field()}}

...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <h6 class="mb-0 text-uppercase">Testimonials ADD</h6>
            <hr>
            <!-- <div class="card"> -->
            <!-- <div class="card-body"> -->
            <div class="p-4 border rounded" style="background: #fff">
                <form class="row g-3" method="post" action="{{route('testimonial.store', $testimonial->id ?? '')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input class=" form-control" id="cimage" name="id" value="{{ $testimonial->id ?? '' }}" type="text" hidden>	


                    <div class="col-md-12">
                    <h4>Name</h4>
                        <label for="validationDefault02" class="form-label"></label>
                        <input class=" form-control" id="cimage" name="name" type="text" value="{{ $testimonial->name ?? '' }}"
                    ...
                    <h4>Content</h4>
                        <label for="validationDefault02" class="form-label"></label>
                        <textarea name="content" id="editor1" rows="5" cols="80"  class="form-control">{{ $testimonial->content ?? '' }}</textarea>

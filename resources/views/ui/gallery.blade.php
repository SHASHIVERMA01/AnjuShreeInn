...
<head>
    ...
    @foreach(App\Models\metas::where('page_name','gallery')->get() as $meta)
...
<body id="bodys">
    ...
    @foreach(App\Models\bigbanners::where('title','Gallery')->get() as $banner)
                ...
                <div class="grid-list gallery">
                    <div class="grid-box row" data-lightbox-anima="show-scale">
                        ...
                        <div class="grid-item col-md-3">
                            <a class="img-box i-center img-scale-rotate" href="/storage/homepage/{{$gallery->image}}" style="height:185px;">
                                <i class="fa fa-camera"></i>
                                <img alt="" src="/storage/homepage/{{$gallery->image}}">
                            </a>
                        </div>
                        @endforeach
                        <!-- <div class="grid-item col-md-3">
                            <a class="img-box i-center img-scale-rotate" href="images/gallery/image_2.jpg">
                                <i class="fa fa-camera"></i>
                                <img alt="" src="images/gallery/thumb_2.jpg">
                            </a>
                        </div>
                        <div class="grid-item col-md-3">
                            <a class="img-box mfp-iframe i-center img-scale-rotate" href="www.youtube.com/watch4552.html?v=bpqhStV2_rc">
                                <i class="fa fa-film"></i>
                                <img alt="" src="images/gallery/thumb_3.jpg" />
                            </a>
                        </div>
                        <div class="grid-item col-md-3">
                            <a class="img-box i-center img-scale-rotate" href="images/gallery/image_4.jpg">
                                <i class="fa fa-camera"></i>
                                <img alt="" src="images/gallery/thumb_4.jpg">
                            </a>
                        </div>
                        <div class="grid-item col-md-3">
                            <a class="img-box i-center img-scale-rotate" href="images/gallery/image_5.jpg">
                                <i class="fa fa-camera"></i>
                                <img alt="" src="images/gallery/thumb_5.jpg">
                            </a>
                        </div>
                        <div class="grid-item col-md-3">
                            <a class="img-box i-center img-scale-rotate" href="images/gallery/image_6.jpg">
                                <i class="fa fa-camera"></i>
                                <img alt="" src="images/gallery/thumb_6.jpg">
                            </a>
                        </div>
                        <div class="grid-item col-md-3">
                            <a class="img-box mfp-iframe i-center img-scale-rotate" href="www.youtube.com/watch4552.html?v=bpqhStV2_rc">
                    ...
                    <div class="list-nav">
                        <ul class="pagination-sm pagination-grid" data-page-items="8" data-pagination-anima="show-scale"></ul>
                    </div>
                </div>
            </div>
        </div>
